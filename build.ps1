...
$animationAssets = @{ 'unified-sheet.png' = 'UnifiedSprites'; 'atlas.json' = 'AnimationAtlas'; 'motion-fields.gz' = 'MotionFields' }
foreach ($name in $animationAssets.Keys) {
    $assetPath = Join-Path $projectDir ('assets\animations\v5\' + $name)
